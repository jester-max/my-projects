...
export function updateFunction(data:any) {

  var array:any = []

  for (let keyMain in data) {
    const updateEntries = Object.entries(data[keyMain]);
    updateEntries.forEach(([keySec, value]) => {
      if (!Array.isArray(value)){
        array.push({key:keySec,type:typeof value,relation:'array',belong:keyMain,isArray:false,primarykey:false,fkey:false,ckey:false,uppercase:false,
          Default:true,default:value,required:false,enum:false,enumValues: ["BANK OF INDIA", "STATE BANK", "PUNJAB BANK", "ICICI BANK"],minlength:"1",maxlength:"100",boolean:true,
          autoIncrement:false,lowercase:false,trim:false,unique:false,min:0,max:0,sign:false,unsign:false,float:false,int:false,floor:false,celling:false,steps:0,indexes:false,hasFeilds:'old',dateToFormat:'isoDate',indexType:'',moduleName:'',subModuleName:'',primaryKey2:'',operation:''})

      } else if (Array.isArray(value)){

        var arrayFields = {key:keySec,type:'array',value:[{}],relation:'array',belong:'array',isArray:true,primarykey:false,fkey:false,ckey:false,uppercase:false,
          Default:true,required:false,enum:false,enumValues: ["BANK OF INDIA", "STATE BANK", "PUNJAB BANK", "ICICI BANK"],minlength:"1",maxlength:"100",boolean:true,
          autoIncrement:false,lowercase:false,trim:false,unique:false,min:0,max:0,sign:false,unsign:false,float:false,int:false,floor:false,celling:false,steps:0,indexes:false,hasFeilds:'old',dateToFormat:'isoDate',indexType:'',moduleName:'',subModuleName:'',primaryKey2:'',operation:''}
        ...
        entries.forEach(([keySec, value]) => {
          ...
          arrayFields.value.push({key:keySec,type:typeof value,relation:'array',belong:'array',isArray:true,primarykey:false,fkey:false,ckey:false,uppercase:false,
            Default:true,default:value,required:false,enum:false,enumValues: ["BANK OF INDIA", "STATE BANK", "PUNJAB BANK", "ICICI BANK"],minlength:"1",maxlength:"100",boolean:true,
            autoIncrement:false,lowercase:false,trim:false,unique:false,min:0,max:0,sign:false,unsign:false,float:false,int:false,floor:false,celling:false,steps:0,indexes:false,hasFeilds:'old',dateToFormat:'isoDate',indexType:'',moduleName:'',subModuleName:'',primaryKey2:'',operation:''})
