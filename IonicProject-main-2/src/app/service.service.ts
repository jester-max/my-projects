...
export class ServiceService {
 ...
 header:any = new HttpHeaders({
  ...
  url:any = 'http://35.154.166.156:3001'
  ...
  // CreateMistake(mistake:any,token:any){
  //   return this.http.post(`${this.url}/v1/mistake/ionic/${token}`,mistake)
  // }
  //
  // GetMistake(token:any){
  //   return this.http.get(`${this.url}/v1/mistake/ionic/${token}`)
  // }
