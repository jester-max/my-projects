...
const createEmployeeData = asyncHandler( async function (req, res)  {
...
const getEmployeeData = asyncHandler( async function (req, res)  {
...
module.exports = {getEmployeeData,createEmployeeData}