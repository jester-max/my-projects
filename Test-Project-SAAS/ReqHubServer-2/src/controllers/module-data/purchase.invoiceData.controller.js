...
const createPurchaseData = asyncHandler( async function (req, res)  {
...
const getPurchaseData = asyncHandler( async function (req, res)  {
...
module.exports = {getPurchaseData,createPurchaseData}
