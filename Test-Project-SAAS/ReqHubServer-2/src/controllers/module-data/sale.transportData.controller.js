...
const createTransportData = asyncHandler( async function (req, res)  {
...
const getTransportData = asyncHandler( async function (req, res)  {
...
module.exports = {getTransportData,createTransportData}
