...
const {createPurchaseData, getPurchaseData} = require("../../controllers/module-data/purchase.invoiceData.controller");
const {createQuotationData, getQuotationData} = require("../../controllers/module-data/purchase.quotationData.controller");
...
invoiceRoute.route('/tenant/purchase_quotation/create-quotation/:tenantID').post(createQuotationData)
invoiceRoute.route('/tenant/purchase_quotation/get-quotation/:tenantID').get(getQuotationData)
