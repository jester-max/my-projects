...
const {createInvocieStructure, getInvocieStructure, updateInvocieStructure}
    = require("../../controllers/module-structure/sale.invoiceStructure.controller");
const {getquotationStructure, createQuotationStructure, updateQuotationStructure}
    = require("../../controllers/module-structure/sale.quotationStructure.controller");
const {getTransportStructure, createTransportStructure, updateTransportStructure}
    = require("../../controllers/module-structure/sale.transportStructure.controller");
