...
const {createInvocieData, getInvocieData,deleteInvoiceData} =
    require("../../controllers/sale/invoice.data.controller");
const {createQuotationData, getQuotationData} = require("../../controllers/sale/quotation.data.controller");
const {createTeantData} = require("../../controllers/tenant/create.tenant.controller");
const {createTransportData, getTransportData} = require("../../controllers/sale/transport.data.controller");
...
invoiceRoute.route('/data-production/delete-invoice/:data-production').delete(deleteInvoiceData)


invoiceRoute.route('/tenant/sale/create-quotation/:tenantID').post(createQuotationData)
invoiceRoute.route('/tenant/sale/get-quotation/:tenantID').get(getQuotationData)

invoiceRoute.route('/tenant/sale/create-transport/:tenantID').post(createTransportData)
invoiceRoute.route('/tenant/sale/get-transport/:tenantID').get(getTransportData)
