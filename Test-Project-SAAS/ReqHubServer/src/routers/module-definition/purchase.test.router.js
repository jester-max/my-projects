...
const {getQuotationStructure, createQuotationStructure, updateQuotationStructure} = require("../../controllers/purchase/quotation.structure.controller");
const {getPurchaseStructure, createPurchaseStructure, updatePurchaseStructure} = require("../../controllers/purchase/invoice.structure.controller");
