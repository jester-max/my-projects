...
const tenantSchema = require('../models/tenant/create.tenant.schema');


const invoiceSchema = require('../models/sale/invoice.schema');
const quotationSchema = require('../models/sale/quatation.schema');
...
const employeeSchema = require('../models/employee/employee.schema');
const customerSchema = require('../models/customer/customer.schema');
const defaultAdminSchema = require('../models/admin/default.services.schema');
const defaultAdminStaticSchema = require('../models/staticData.schema');
...
const getTenantModelMongodb = async (tenantName) => {
  ...
  const tenantDb = await getMongodbTenantModel(tenantName);
