...
exports.createCustomerData = async function (req,res,next) {
    try {
        ...
        if(tenant){
            ...
            const result = await createTable('customer','customer', modifiedData, null,null,modifiedData,creatingTableArray);
            ...
            for (let i = result.length-1; i >= 0 ; i--) {
                ...
                if(i===result.length-1){
                    ...
                    const substringToRemove = "customer_";
...
exports.getCustomerData = async function (req,res) {
    try {


        const sqpQuery = `select * from customer`;
