...
const { getCustomerModelMongodb, getTenantModelMongodb, getEmployeeModelMongodb} = require('../../databases/tenant.mongodb.connection');
...
exports.createCustomerStructure = async function (req,res) {
    try {
        ...
        if(tenant){
            ...
            console.log(customerModel,tenant.tenantID)
...
exports.getCustomerStructure = async function (req,res) {
    try {
...
exports.updateCustomerStructure = async function (req,res) {
    try {
        ...
        if(tenant){
            ...
            for (const field of formData) {
                if(field.hasFeilds === 'new'){
                    ...
                    updateQuery = `ALTER TABLE customer ADD COLUMN IF NOT EXISTS ${newKey} TEXT DEFAULT '${value}';`;
