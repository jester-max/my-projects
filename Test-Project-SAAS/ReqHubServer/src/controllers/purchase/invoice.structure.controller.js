...
exports.createPurchaseStructure = async function (req,res) {
    try {
...
exports.getPurchaseStructure = async function (req,res) {
    try {
...
exports.updatePurchaseStructure = async function (req,res) {
    try {
        ...
        if(tenant){
            ...
            for (const field of formData) {
                if(field.hasFeilds === 'new'){
                    ...
                    updateQuery = `ALTER TABLE purchase_invoice ADD COLUMN IF NOT EXISTS ${newKey} TEXT DEFAULT '${value}';`;
