...
exports.createEmployeeStructure = async function (req,res) {
    try {
...
exports.getEmployeeStructure = async function (req,res) {
    try {
...
exports.updateEmployeeStructure = async function (req,res) {
    try {
        ...
        if(tenant){
            ...
            for (const field of formData) {
                if(field.hasFeilds === 'new'){
                    ...
                    updateQuery = `ALTER TABLE employee ADD COLUMN IF NOT EXISTS ${newKey} TEXT DEFAULT '${value}';`;
